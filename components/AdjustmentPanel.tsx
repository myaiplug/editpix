    ...
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      ...
      {isAdminMode && showMoreAdjustments && (
        <div className="border-t border-[#7C4DFF]/20 pt-4 mt-2">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-sm font-bold text-[#7C4DFF]">Pro-Level Adjustments</span>
          </div>
      ...
      {isAdminMode && (
        <button
          ...
          className="flex items-center justify-center gap-2 w-full text-center bg-transparent border border-[#7C4DFF]/30 text-[#7C4DFF] font-semibold py-2 px-4 rounded-md transition-all duration-200 ease-in-out hover:bg-[#7C4DFF]/10 hover:border-[#7C4DFF]/50 active:scale-95 text-base"
        >
